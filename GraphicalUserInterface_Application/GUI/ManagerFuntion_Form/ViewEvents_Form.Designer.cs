namespace GraphicalUserInterface_Application.GUI.ManagerFuntion_Form
{
    partial class ViewEvents_Form
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ViewEvents_Form));
            panel2 = new Panel();
            panel1 = new Panel();
            button12 = new Button();
            label1 = new Label();
            ...
            Name = "ViewEvents_Form";
            Text = "ViewEvents_Form";
            Load += ViewEvents_Form_Load;
